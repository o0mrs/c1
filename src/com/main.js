...
{/* Card Video chat */}
<div className="text-3xl mt-[1.5rem] md:text-4xl font-bold">
TRUTH <br />OR DARE
</div>
<div className="float-right">
<button type="button" onClick={()=>{navigate("/play/t", { replace: true });}} className="mt-[1.2rem] md:mt-14 mr-2 btn btn-outline btn-accent text-white" >START</button>
</div>
</div>
